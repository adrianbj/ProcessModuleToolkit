$(document).ready(function() {
    ...
    $("#wrap_Inputfield_upgrade_cleanup #Inputfield_upgrade_cleanup_toggleAll").on('click', function () {
    ...
    $("#wrap_Inputfield_upgrade_cleanup input[type=checkbox]:not('#Inputfield_upgrade_cleanup_toggleAll')").on('click', function () {
    ...
    $("#wrap_Inputfield_selectedModules #Inputfield_selectedModules_toggleAll").on('click', function () {
    ...
    $("#wrap_Inputfield_selectedModules input[type=checkbox]:not('#Inputfield_selectedModules_toggleAll')").on('click', function () {
    ...
    $("#wrap_Inputfield_upgradeCleanup #Inputfield_upgradeCleanup_toggleAll").on('click', function () {
    ...
    $("#wrap_Inputfield_upgradeCleanup input[type=checkbox]:not('#Inputfield_upgradeCleanup_toggleAll')").on('click', function () {
